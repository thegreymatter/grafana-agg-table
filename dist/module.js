...
var statusCellBuilder = exports.statusCellBuilder = function statusCellBuilder(cell) {
  ...
  var getColor = function getColor(element) {
    if (element.color === undefined || element.color === null) return "black";else if (element.color > 0.7) return "green";else if (element.color < 0.4) return "red";else return "orange";
  };

  var getBgColor = function getBgColor(element) {
