...
/***/ "../node_modules/css-loader/index.js?!./style/module.css":
/*!***************************************************************!*\
  !*** ../node_modules/css-loader??ref--5-1!./style/module.css ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "table.table-wrapper {\r\n    width: 100%;\r\n}\r\n\r\nthead.table-header-wrapper {\r\n    background: #eee;\r\n    color: #000;\r\n    font-size: 18px;\r\n}\r\n\r\ntbody.table-body-wrapper {\r\n    background: #cdcccc;\r\n    color: #000;\r\n    font-size: 14px;\r\n}\r\n\r\n.green {\r\n\tbackground-color: green;\r\n}\r\n\r\n.red {\r\n\tbackground-color: red;\r\n}\r\n.no-data{\r\n\tdisplay: flex;\r\n\tflex:1 100%;\r\n\tfont-size: 40px;\r\n\tjustify-content: center;\r\n\talign-items: center;\r\n}\r\n\r\n\r\n.section.atb-settings {\r\n    display: flex;\r\n    flex-wrap: wrap;\r\n    justify-content: flex-start;\r\n}\r\n\r\n.section.atb-settings .section-heading {\r\n    font-size: 20px;\r\n    color: #fff;\r\n    text-transform: capitalize;\r\n    flex: 1 100%;\r\n}\r\n\r\n.section.atb-settings .gf-form-switch-container-react {\r\n    margin: 5px\r\n    \r\n}\r\n\r\n.section.atb-settings .panel-options-group {\r\n    margin: 5px\r\n}", "", {"version":3,"sources":["C:/dev/plugins/grafana-agg-table/src/style/module.css"],"names":[],"mappings":"AAAA;IACI,YAAY;CACf;;AAED;IACI,iBAAiB;IACjB,YAAY;IACZ,gBAAgB;CACnB;;AAED;IACI,oBAAoB;IACpB,YAAY;IACZ,gBAAgB;CACnB;;AAED;CACC,wBAAwB;CACxB;;AAED;CACC,sBAAsB;CACtB;AACD;CACC,cAAc;CACd,YAAY;CACZ,gBAAgB;CAChB,wBAAwB;CACxB,oBAAoB;CACpB;;;AAGD;IACI,cAAc;IACd,gBAAgB;IAChB,4BAA4B;CAC/B;;AAED;IACI,gBAAgB;IAChB,YAAY;IACZ,2BAA2B;IAC3B,aAAa;CAChB;;AAED;IACI,WAAW;;CAEd;;AAED;IACI,WAAW;CACd","file":"module.css","sourcesContent":["table.table-wrapper {\r\n    width: 100%;\r\n}\r\n\r\nthead.table-header-wrapper {\r\n    background: #eee;\r\n    color: #000;\r\n    font-size: 18px;\r\n}\r\n\r\ntbody.table-body-wrapper {\r\n    background: #cdcccc;\r\n    color: #000;\r\n    font-size: 14px;\r\n}\r\n\r\n.green {\r\n\tbackground-color: green;\r\n}\r\n\r\n.red {\r\n\tbackground-color: red;\r\n}\r\n.no-data{\r\n\tdisplay: flex;\r\n\tflex:1 100%;\r\n\tfont-size: 40px;\r\n\tjustify-content: center;\r\n\talign-items: center;\r\n}\r\n\r\n\r\n.section.atb-settings {\r\n    display: flex;\r\n    flex-wrap: wrap;\r\n    justify-content: flex-start;\r\n}\r\n\r\n.section.atb-settings .section-heading {\r\n    font-size: 20px;\r\n    color: #fff;\r\n    text-transform: capitalize;\r\n    flex: 1 100%;\r\n}\r\n\r\n.section.atb-settings .gf-form-switch-container-react {\r\n    margin: 5px\r\n    \r\n}\r\n\r\n.section.atb-settings .panel-options-group {\r\n    margin: 5px\r\n}"],"sourceRoot":""}]);
...
function transform(rows, fields, options) {
  ...
  var color_location = options.color;
  var trend_location = options.trend;

  var possibleRows = _underscore2.default.uniq(rows.map(function (x) {
    return x[xfield_location];
  }));

  var PossibleColumns = _underscore2.default.uniq(rows.map(function (x) {
  ...
  var newRows = possibleRows.map(function (row) {
    var newRow = PossibleColumns.map(function (col) {
      var items = rows.filter(function (f) {
        return f[xfield_location] == row && f[yfield_location] == col;
      });
      if (items.length == 0) return {};else return {
        value: items[0][valfield_location],
        color: items[0][color_location],
        trend: items[0][trend_location]
      };
    });
    newRow.unshift(row);
    return newRow;
  });
  var newFields = PossibleColumns.map(function (x) {
    return {
      "name": x,
      "type": "string"
    };
...
var _statusTableEditor = __webpack_require__(/*! ./statusTableEditor */ "./statusTableEditor.tsx");

var _types = __webpack_require__(/*! ./types */ "./types.ts");

__webpack_require__(/*! ./style/module.css */ "./style/module.css");

var _statusTablePanel = __webpack_require__(/*! ./statusTablePanel */ "./statusTablePanel.tsx");

var plugin = exports.plugin = new _ui.PanelPlugin(_statusTablePanel.StatusTablePanel).setDefaults(_types.defaults).setEditor(_statusTableEditor.statusTableEditor);

/***/ }),

/***/ "./statusCellBuilder.tsx":
/*!*******************************!*\
  !*** ./statusCellBuilder.tsx ***!
  \*******************************/
/*! no static exports found */
...
exports.rowCellBuilder = exports.statusCellBuilder = undefined;
...
var statusCellBuilder = exports.statusCellBuilder = function statusCellBuilder(cell) {
  ...
  var getColor = function getColor(element) {
    if (!element.color) return "black";else if (element.trend > 0.1) return "green";else if (element.trend < -0.1) return "red";else return "lime";
  };
  ...
  }, value.value || "n\\a"), getTrend(value));
};

var rowCellBuilder = exports.rowCellBuilder = function rowCellBuilder(cell) {
...
var _statusCellBuilder = __webpack_require__(/*! ./statusCellBuilder */ "./statusCellBuilder.tsx");
...
function (_super) {
  ...
  function StatusTable(props) {
    ...
    _this.onCellClick = function (rowIndex, columnIndex) {
      ...
      var values = _this.props.data.rows[row];
    ...
    _this.getTableCellBuilder = function (column) {
      if (column == 0) return _statusCellBuilder.rowCellBuilder;
      return _statusCellBuilder.statusCellBuilder; // the default
    };
    ...
    _this.getColumnWidth = function (col) {
      return Math.max((_this.props.width - 10) / _this.props.data.fields.length, _this.props.minColumnWidth);
      ;
    };

    _this.measurer = new _reactVirtualized.CellMeasurerCache({
      defaultHeight: 30,
      fixedWidth: true
    });
    return _this;
  ...
  StatusTable.prototype.componentDidUpdate = function (prevProps) {
    var _a = this.props,
        data = _a.data,
        showHeader = _a.showHeader,
        rotate = _a.rotate;
    var dataChanged = data !== prevProps.data;
    var configsChanged = showHeader !== prevProps.showHeader || this.props.rotate !== prevProps.rotate || this.props.fixedColumns !== prevProps.fixedColumns || this.props.fixedHeader !== prevProps.fixedHeader; // Reset the size cache
  ...
  StatusTable.prototype.render = function () {
    var _a = this.props,
        showHeader = _a.showHeader,
    ...
    if (!data || !data.fields || !data.fields.length) {
      return _react2.default.createElement("span", null, "Missing Fields"); // nothing
    }
    ...
    return _react2.default.createElement(_reactVirtualized.MultiGrid, __assign({}, refreshKeys, {
      scrollToRow: scrollToRow,
...
exports.statusTableEditor = undefined;
...
var statusTableEditor =
/** @class */
function (_super) {
  __extends(statusTableEditor, _super);
  ...
  statusTableEditor.prototype.render = function () {
    var _this = this;
  ...
  return statusTableEditor;
}(_react.PureComponent);

exports.statusTableEditor = statusTableEditor;

/***/ }),

/***/ "./statusTablePanel.tsx":
/*!******************************!*\
  !*** ./statusTablePanel.tsx ***!
  \******************************/
/*! no static exports found */
...
exports.StatusTablePanel = undefined;
...
var _aggregationTransformer = __webpack_require__(/*! ./aggregationTransformer */ "./aggregationTransformer.ts");

var _statusTable = __webpack_require__(/*! ./statusTable */ "./statusTable.tsx");
...
var StatusTablePanel =
/** @class */
function (_super) {
  __extends(StatusTablePanel, _super);
  ...
  StatusTablePanel.prototype.render = function () {
    ...
    if (data['series'][0]) {
      ...
      return _react2.default.createElement(_ui.ThemeContext.Consumer, null, function (theme) {
        return _react2.default.createElement(_statusTable.StatusTable, __assign({}, _this.props, options, {
          theme: theme,
          data: {
            rows: rows_1,
            fields: fields_1
  ...
  return StatusTablePanel;
}(_react.Component);

exports.StatusTablePanel = StatusTablePanel;
...
var content = __webpack_require__(/*! !../../node_modules/css-loader??ref--5-1!./module.css */ "../node_modules/css-loader/index.js?!./style/module.css");
