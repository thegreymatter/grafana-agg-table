...
function (_super) {
  ...
  MyPanel.prototype.render = function () {
    ...
    var _a = (0, _aggregationTransformer.transform)(data[0].rows, data[0].fields),
        rows = _a.rows,
        fields = _a.fields;
    ...
    }))), _react2.default.createElement("tbody", null, rows.map(function (element) {
      return _react2.default.createElement("tr", null, element.map(function (element) {
        return _react2.default.createElement("td", null, " ", element);
      }));
    }))));
  };
